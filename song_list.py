...
CUSTOM_TRACKS = {
    ...
    "Back Door": (25000, 70),  # Start at 0:25, play for 70 seconds, stop at 1:35  (revisit)
    ...
    "Same Old Lang": (158000, 55),  # Start at 2:39, play for 56 seconds, stop at 3:34 (revisit)
    ...
    # Check Brenda Lee for 60 vs 61 seconds when using Dem Beats
    "Daryl Hall": (0, 67),  # Play for 67 seconds, stop at 1:07
    "Thistlehair": (19000, 63),  # Start at 0:19, play for 63 seconds, stop at 1:22
    "Burl Ives": (0, 68),  # Play for 68 seconds, stop at 1:08  (revisit on Dem Beats)
    ...
    "John Denver": (0, 70),  # Play for 70 seconds, stop at 1:10  (revisit)
    ...
    "Patapan": (0, 71),  # Play for 71 seconds, stop at 1:11  (revisit)
    "Cherry Cherry": (121000, 82),  # Start at 2:01, play for 82 seconds, stop at 3:23 (revisit)
    ...
    "I Guess It's Christmas": (85000, 68),  # Start at 1:25, play for 68 seconds, stop at 2:33
    "Carrie Underwood": (175000, 61),  # Start at 2:55, play for 61 seconds, stop at 3:56
    "Happy Hanukkah": (0, 216),  # Play full song, stop at 3:36  (maybe shorten)
    ...
    "Mary, Did You Know": (8000, 68),  # Start at 0:08, play for 68 seconds, stop at 1:16
    "Happy Birthday Jesus": (10000, 63),  # Start at 0:10, play for 63 seconds, stop at 1:13
    "Jackson 5": (3000, 61),  # Start at 0:03, play for 61 seconds, stop at 1:04
    ...
    "Believe Josh": (158000, 61),  # Start at 2:38, play for 61 seconds, stop at 3:39
